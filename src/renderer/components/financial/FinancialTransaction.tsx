...
import FinancialListModal, { FinancialListModalHandle } from './FinancialListModal';
import { TransactionKind } from '../common/BokslTypes';
import { downloadForTable } from '../util/util';

function FinancialTransaction() {
  const financialListModalRef = useRef<FinancialListModalHandle>(null);
  ...
  function openList(type: TransactionKind, year: number, month: number) {
    financialListModalRef.current?.openModal(type, year, month);
  }
  ...
  return (
    <Container fluid className="ledger-table">
      ...
      <FinancialListModal ref={financialListModalRef} />
    </Container>
  );
}
